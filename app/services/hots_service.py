...
class HOTSService:
    ...
    def __init__(self):
        ...
        try:
            ...
            model_name = getattr(settings, 'gemini_model_standard', 'gemini-2.5-flash')
            try:
                self.model = genai.GenerativeModel(model_name)
            except:
